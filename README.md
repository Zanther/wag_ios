...
Downloads the list of Users from Stackoverflow API Endpoint, shown below.   

Shows their name, profile pic, reputation, location, and bronze, silver and gold badge count in a UITableView. 
